...
def updateGame():
	...
	for idx, enemy in enumerate(enemyShips):
		...
		if enemy.y < windowHeight:
			...
			enemyIsDestroyed = enemy.checkForHit(enemy)
...
while True:
	...
	if gameStarted is False and gameOver is False:
		...
		surface.blit(startScreen, (0, 0))
		timeLasted = (gameFinishedTime - gameStaredTime) / 1000
	...
	if GAME_TIME.get_ticks() - lastEnemyCreated > enemyInterval and gameStarted is True:
		enemyShips.append(ship.Enemy(random.randint(0, windowWidth), -60, pygame, surface, 1))
